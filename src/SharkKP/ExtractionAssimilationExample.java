...
//        e.example8();
    ...
    public void example8() throws SharkKBException {
        System.out.println("*********************************");
        System.out.println("example 8 starts here:");
        System.out.println("*********************************");
...
//        L.setLogLevel(L.LOGLEVEL_ALL);
        ...
        Knowledge k = SharkCSAlgebra.extract(kb, cc, backgroundFPs, alice);
        Taxonomy topicTax = k.getVocabulary().getTopicsAsTaxonomy();
        TXSemanticTag javaST = topicTax.getSemanticTag("http://en.wikipedia.org/wiki/Java_%28programming_language%29");
        TXSemanticTag plST = topicTax.getSemanticTag("http://en.wikipedia.org/wiki/Programming_language");
        javaST.move(plST);
        
        System.out.println("---------------------------------");
        System.out.println("example 8 - knowledge to be assimilated:");
        System.out.println("---------------------------------");
        System.out.println(L.knowledge2String(k));
        
        
        STSet t = InMemoSharkKB.createInMemoSTSet();
        t.createSemanticTag(null, "http://en.wikipedia.org/wiki/Programming_language");
        ...
        kb2.createSemanticTag("PL", "\"http://en.wikipedia.org/wiki/Programming_language\"");
        
        backgroundFPs[SharkCS.DIM_TOPIC] = new FragmentationParameter(true, true, 1);
